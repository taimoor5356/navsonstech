    ...
    <div class="container-fluid position-relative d-flex align-items-center justify-content-between">
      ...
      <nav id="navmenu" class="navmenu">
        ...
        <div class="social-links text-center">
          <a href="https://x.com/NavsonsGroup" class="twitter"><i class="bi bi-twitter-x"></i></a>
          <a href="https://www.facebook.com/people/Navsons-Group/61569995770591/" class="facebook"><i class="bi bi-facebook"></i></a>
